...
const PopularProducts = ({ productState }) => {
  const PopularProductsState = productState?.filter(
  ...
  return (
    <div className="w-5/6 mx-auto pt-10">
      <h2 className="py-3 mb-4 text-white">Popular Products</h2>
      <div className="flex flex-wrap gap-5">
        {PopularProductsState &&
          PopularProductsState?.map((product) => (
            <div
            ...
            >
              ...
              <div className="action-bar flex mt-3 flex-col gap-5 absolute right-[-40px] top-12 sm:right-[20px]">
                <button
